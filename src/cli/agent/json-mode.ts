...
import { detectMode, type EmitOptions, type OutputMode, shouldColor } from '../platform/detect'

// Re-export so consumers can import everything from json-mode
export { detectMode, type EmitOptions, type OutputMode as Mode, shouldColor }
